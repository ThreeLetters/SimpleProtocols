...
module.exports = function (obj, data, name, type, lvl, opt) {
    ...
    switch (type) {
        case 0: // no object
            code = "data" + lvl2 + "=(" + get + ")" + scramble + ";";
            code2 = set + "data" + lvl2 + scramble + off2 + ")";
            if (count) data.count.push(count + "data" + lvl2 + scramble + off2 + ")");
            break;
        case 1: // object
            code = "data" + lvl + "." + name + "=(" + get + ")" + scramble + ";";
            code2 = set + "data" + lvl + "." + name + scramble + off2 + ");";
            if (count) data.count.push(count + "data" + lvl + "." + name + scramble + off2 + ");");

            break;
        case 2: // array
            code = "data" + lvl + ".push((" + get + ")" + scramble + ");"
            code2 = set + "data" + lvl2 + scramble + off2 + ");";
            if (count) data.count.push(count + "data" + lvl2 + scramble + off2 + ");");
            break;
    }
