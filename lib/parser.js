...
module.exports = function (object, options) {
    ...
    data.count.push("var writer = new Writer(byteLen + (startIndex || 0), startIndex);")
    ...
    var set = "function " + options.setname + "(data1, startIndex) {\n" + FastBuffers.NodeJS("writer") + "\n" + setCode + "}";
    var getBrowser = "function " + options.getname + "(buf, startIndex) {\n" + FastBuffers.Browser("reader") + "\n" + getCode + "}";
    var setBrowser = "function " + options.setname + "(data1, startIndex) {" + FastBuffers.Browser("writer") + "\n" + setCode + "}";
