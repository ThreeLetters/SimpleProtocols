...
module.exports = function (obj, data, parse, lvl) {
    ...
    var lvl2 = lvl + 1;
    data.set.push("var len" + lvl2 + " = data" + lvl + ".length")
    data.set.push("writer.writeUInt16BE(len" + lvl2 + ")")
    data.set.push("for (var i" + lvl2 + " = 0; i" + lvl2 + " < len" + lvl2 + "; i" + lvl2 + " ++) {")
    data.set.push("var data" + lvl2 + " = data" + lvl + "[i" + lvl2 + "];")
    data.set.push4("}")
